...
const NAV = [
  ...
  { href:'/calendar',     label:'Calendar',    icon:'M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 0 0 2-2V7a2 2 0 0 0-2-2H5a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2z' },
  ...
  { href:'/connect',      label:'Connect',     icon:'M13 2L3 14h9l-1 8 10-12h-9l1-8z' },
